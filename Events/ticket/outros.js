...
client.on("interactionCreate", async interaction => {
        ...
        if (interaction.isButton()) {
            if (interaction.customId === "outros") {
                if (interaction.guild.channels.cache.find(c => c.name === `ticket-${member.id}`)) {
                    let c = interaction.guild.channels.cache.find(c => c.name === `ticket-${member.id}`);
